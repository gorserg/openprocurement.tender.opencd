...
from openprocurement.tender.opencd.tests.base import BaseTenderContentWebTest
...
class TenderDocumentResourceTest(BaseTenderContentWebTest):
    ...
    def test_patch_tender_document(self):
        ...
        response = self.app.patch_json('/tenders/{}/documents/{}?acc_token={}'.format(self.tender_id, doc_id, self.tender_token),
