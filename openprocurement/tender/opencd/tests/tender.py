...
from openprocurement.tender.opencd.tests.base import (test_tender_data,
                                                      BaseTenderWebTest)
...
class TenderTest(BaseTenderWebTest):
    ...
    def test_simple_add_tender(self):
        ...
        assert u.procurementMethodType == "aboveThresholdCD"
        assert fromdb['procurementMethodType'] == "aboveThresholdCD"
