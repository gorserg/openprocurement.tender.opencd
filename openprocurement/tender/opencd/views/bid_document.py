...
from openprocurement.tender.opencd.utils import (
...
@opresource(name='Tender CD Bid Documents',
            collection_path='/tenders/{tender_id}/bids/{bid_id}/documents',
            path='/tenders/{tender_id}/bids/{bid_id}/documents/{document_id}',
            procurementMethodType='aboveThresholdCD',
            description="Tender CD bidder documents")
class TenderCDBidDocumentResource(TenderUaBidDocumentResource):
    ...
    def patch(self):
        ...
        if self.request.validated['tender_status'] != 'active.tendering' and 'confidentiality' in self.request.validated['data'] \
            ...
            self.request.errors.add('body', 'data', 'Can\'t update document confidentiality in current ({0}) tender status'.format(self.request.validated['tender_status']))
            self.request.errors.status = 403
            return
...
@bid_financial_documents_resource(
    name='Tender CD Bid Financial Documents',
    ...
    procurementMethodType='aboveThresholdCD',
    description="Tender CD bidder financial documents")
class TenderCDBidFinancialDocumentResource(TenderCDBidDocumentResource):
    """ Tender CD Bid Financial Documents """
...
@bid_eligibility_documents_resource(name='Tender CD Bid Eligibility Documents',
    ...
    procurementMethodType='aboveThresholdCD',
    description="Tender CD bidder eligibility documents")
class TenderCDBidEligibilityDocumentResource(TenderCDBidFinancialDocumentResource):
    """ Tender CD Bid Eligibility Documents """
    container = "eligibilityDocuments"


@bid_qualification_documents_resource(name='Tender CD Bid Qualification Documents',
    ...
    procurementMethodType='aboveThresholdCD',
    description="Tender CD bidder qualification documents")
class TenderCDBidQualificationDocumentResource(TenderCDBidFinancialDocumentResource):
    """ Tender CD Bid Qualification Documents """
