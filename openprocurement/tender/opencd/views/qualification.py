...
from openprocurement.tender.opencd.validation import validate_patch_qualification_data
from openprocurement.tender.opencd.utils import qualifications_resource, prepare_qualifications


@qualifications_resource(
    name='TenderCD Qualification',
    ...
    description="TenderCD Qualification")
