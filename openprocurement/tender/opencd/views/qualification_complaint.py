...
from openprocurement.tender.opencd.views.award_complaint import TenderCDAwardComplaintResource
...
@qualifications_resource(
    name='Tender CD Qualification Complaints',
...
class TenderCDQualificationComplaintResource(TenderCDAwardComplaintResource):
    ...
    def collection_post(self):
        ...
        if save_tender(self.request):
            ...
            self.request.response.headers['Location'] = self.request.route_url('Tender CD Qualification Complaints', tender_id=tender.id, qualification_id=self.request.validated['qualification_id'], complaint_id=complaint['id'])
            return {
