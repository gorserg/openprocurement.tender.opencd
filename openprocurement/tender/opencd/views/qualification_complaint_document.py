# -*- coding: utf-8 -*-
from openprocurement.tender.opencd.views.award_complaint_document import TenderCDAwardComplaintDocumentResource
...
@qualifications_resource(
    name='Tender CD Qualification Complaint Documents',
...
class TenderCDQualificationComplaintDocumentResource(TenderCDAwardComplaintDocumentResource):
