...
from openprocurement.tender.opencd.models import PREQUALIFICATION_COMPLAINT_STAND_STILL as COMPLAINT_STAND_STILL
from openprocurement.tender.opencd.utils import check_status, all_bids_are_reviewed
...
@opresource(name='Tender CD',
            path='/tenders/{tender_id}',
            procurementMethodType='aboveThresholdCD',
            description="Open Contracting compatible data exchange format. See http://ocds.open-contracting.org/standard/r/master/#tender for more info")
class TenderCDResource(TenderResource):
    """ Resource handler for TenderCD """
    ...
    def patch(self):
        ...
        if self.request.authenticated_role == 'chronograph':
            ...
            if all_bids_are_reviewed(self.request):
                tender.qualificationPeriod.endDate = calculate_business_date(get_now(), COMPLAINT_STAND_STILL, self.request.validated['tender'])
